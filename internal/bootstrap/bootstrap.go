...
// release binary (see configs/defaults.lock and scripts/build-binaries.sh)
...
// scripts/build-binaries.sh from configs/defaults.lock.
...
// configs/defaults.lock and scripts/build-binaries.sh) into the plugin store
